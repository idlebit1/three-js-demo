// Reverie — float world
// Wooden floor + mountains + altitude layers + bookshelves + floating papers + warm motes + clocks
...
export default {
    ...
    create(THREE, group) {
        ...
        return { lowClouds, highClouds, grandBirds, floatingIslands, auroraLights, stars, papers, clocks };
    },
