// Ascent — float world
// Green ground + trees + mountains + altitude layers + giant bamboo stalks + floating lanterns
...
export default {
    ...
    create(THREE, group) {
        ...
        return { lowClouds, highClouds, grandBirds, floatingIslands, auroraLights, stars, lanterns };
    },
